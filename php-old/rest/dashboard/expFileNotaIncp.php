...
switch ($requestMethod) {
    case 'GET':
        ...
        $json = $model->showfilesNotaIncPdf($datas);
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="row"><textarea name="" style="display: none;" id="text<?= $filedat->id ?>" cols="30" rows="10"><?= $filedat->url ?></textarea>
                                ...
                                <div class="col-12 col-md-12 col-lg-6"><button type="button" name="" onclick="erasedocksNotaInc('<?= $datas ?>','<?= $filedat->id ?>')" id="" class="btn btn-danger btn-block">Borrar archivo <i class="fas fa-backspace"></i></button></div>
                            </td>

-- =============================================================================
-- FIX: UX_FS_FILE_CHECKSUM de UNIQUE a NONUNIQUE (QA ONEWMS_QA)
-- =============================================================================
...
--           APP_FS_FILE.CHECKSUM_SHA256 tiene 261 duplicados de contenido
...
DROP INDEX UX_FS_FILE_CHECKSUM;

CREATE INDEX UX_FS_FILE_CHECKSUM ON APP_FS_FILE (CHECKSUM_SHA256);

-- Verificacion (debe mostrar NONUNIQUE):
-- SELECT INDEX_NAME, UNIQUENESS FROM ALL_INDEXES
--  WHERE TABLE_NAME = 'APP_FS_FILE' AND INDEX_NAME = 'UX_FS_FILE_CHECKSUM';
